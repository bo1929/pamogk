...
def get_n2v_representations():
    ...
    parser.add_argument(
        ...
        dest="q",
        type=float,
        help="Node2Vec q value",
        default=1,
    )
    parser.add_argument(
        "--node2vec-size",
        "-n",
        metavar="node2vec-size",
        dest="n2v_size",
        type=float,
        help="Node2Vec feature space size",
        default=128,
    )
    parser.add_argument(
        "--run-id",
    ...
    parser.add_argument(
        ...
        dest="num_pat",
        type=int,
        help="Number of Patients for Synthetic Experiments",
        default=1000,
    )
    parser.add_argument(
        "--surv-dist",
        ...
        dest="surv_dist",
        type=float,
        help="Surviving patient percentage in range [0, 1]",
        default=0.9,
    )
    parser.add_argument(
        "--mut-dist",
        ...
        dest="mut_dist",
        type=float,
        help="Mutated gene percentage in range [0, 1]",
        default=0.4,
    )
