...
def process(filename, is_continuous=False, threshold=1.96):
    ...
    :param is_continuous: whether or not to discritize z-scores if True returns them as is otherwise discritize them to -1 and 1
    :param threshold: defaults to 1.96 two standard deviation
